...
const fs = require('fs'); // Added for reading cert files
...
async function main() {
    try {
        ...
        // HTTPS server configuration with Let’s Encrypt certs
        const httpsOptions = {
        ...
        https.createServer(httpsOptions, app).listen(443, () => {
            terminal.green(`Faucet listening on https://xte.faucet.trrxitte.com:443\n`);
        });
    } catch (error) {
